...
const site = process.env.CWEBP_BINARY_SITE || process.env.npm_config_cwebp_binary_site || 'https://raw.githubusercontent.com/imagemin/cwebp-bin';
const url = `${site}/v${pkg.version}/vendor/`;
